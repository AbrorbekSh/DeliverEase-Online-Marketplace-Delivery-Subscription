...
//
//var products = [banany, kiwi, kapusta_cvetnaya, apelsiny, apples, avokado, bios, dynya, iogurt_foodmaster, kartofel, laim, limon, luk_belyi, maslo, moloko_naturalnoe, morkov, iogurt_danone, perec_polugorkii_krasnyi, redis, snezhok, syr_lamber, syr_klub, tomaty, tvorog_emil, tvorog_prostokvashino]
//
////var productsCart = [banany, kiwi, kapusta_cvetnaya,banany]
//
//let banany = Product(
